...
class RepositoriesContainerFeatureTest < Minitest::Test
  def test_feature_available_gets_with_correct_params
    mock_client = Minitest::Mock.new
    mock_endpoint = Minitest::Mock.new

    mock_client.expect(:[], mock_endpoint, ["nodes/pve1/lxc/200/feature"])
    ...
    result = repo.feature_available?(200, "pve1", "clone")
  ...
  def test_feature_available_includes_snapname
    mock_client = Minitest::Mock.new
    mock_endpoint = Minitest::Mock.new
    ...
    repo = Pvectl::Repositories::Container.new(connection)
    repo.feature_available?(200, "pve1", "snapshot", snapname: "snap1")
  ...
  def test_feature_available_omits_snapname_when_nil
    ...
    repo = Pvectl::Repositories::Container.new(connection)
    repo.feature_available?(200, "pve1", "copy", snapname: nil)
