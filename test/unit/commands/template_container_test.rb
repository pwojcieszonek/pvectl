  ...
  module Commands
    class TemplateContainerTest < Minitest::Test
      ...
      def test_resource_type_is_set_to_container
        assert_equal :container, TemplateContainer::RESOURCE_TYPE
      end

      def test_supported_resources_includes_container
        assert_includes TemplateContainer::SUPPORTED_RESOURCES, "container"
      end

      def test_supported_resources_includes_ct
        assert_includes TemplateContainer::SUPPORTED_RESOURCES, "ct"
      end

      def test_execute_returns_usage_error_for_missing_resource_type
        result = TemplateContainer.execute(nil, ["200"], {}, {})

        assert_equal ExitCodes::USAGE_ERROR, result
      end

      def test_execute_accepts_ct_alias
        result = TemplateContainer.execute("ct", [], {}, {})
      ...
      def test_execute_returns_usage_error_for_unsupported_resource_type
        result = TemplateContainer.execute("vm", ["200"], {}, {})
