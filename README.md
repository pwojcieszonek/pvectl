...
| Command | Description |
|---------|-------------|
| `get` | List resources (nodes, VMs, containers, storage, disks, volumes, snapshots, backups, tasks, hosts) |
...
| `edit` | Edit resource configuration in $EDITOR (vm, container, node, volume, hosts) |
